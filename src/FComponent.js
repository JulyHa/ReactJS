...
export default function FComponent(){
    ...
    return(
        <>
            ...
            <div>
                Name: <input type="text" name={username} value={username} onChange={(e) => { change(setUsername, e)}}/>
                <br/>
                Age: <input type="text" name={age} value={age} onChange={(e) => {change(setAge, e)}}/>
                <br/>
                <button onClick={() => {add()}}>{isEdit}</button>
            </div>
